"""
Django settings for green_poetry_dev_89623 project.
...
ROOT_URLCONF = 'green_poetry_dev_89623.urls'
...
WSGI_APPLICATION = 'green_poetry_dev_89623.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "green_poetry_dev_89623 API",
    "DESCRIPTION": "API documentation for green_poetry_dev_89623 App",
    "VERSION": "v1",
}
